...
import { getUserProfile, updateUserProfile, changeUserPassword, updateUserAvatar } from './user.service';
import { z } from 'zod';
...
export const updateMyAvatarController = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Foto profil berhasil diperbarui', data: updatedProfile });
